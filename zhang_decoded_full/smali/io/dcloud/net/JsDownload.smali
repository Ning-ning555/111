...
.method public toJSON()Ljava/lang/String;
    ...
    const-string/jumbo v1, "{status: %d,filename: \'%s\',uuid: \'%s\',downloadedSize:%d,totalSize:%d,headers:%s}"
    ...
    const-string/jumbo v1, "{status: %d,state: %d,filename: \'%s\',uuid: \'%s\',downloadedSize:%d,totalSize:%d,headers:%s}"
...
.method toSaveJSON()Ljava/lang/String;
    ...
    const-string/jumbo v1, "{url: \'%s\',uuid: \'%s\',method: \'%s\',priority: %d,timeout:%d,retry:%d,filename:\'%s\',downloadedSize:%d,totalSize:%d,state: %d,options:%s,RealURL:\'%s\'}"
