...
.method private a(Lio/dcloud/common/DHInterface/IApp;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "window.__NATIVE_PLUGINS__ = "
...
.method private a(Lio/dcloud/common/DHInterface/IApp;Lio/dcloud/common/DHInterface/IWebview;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "window._____isDebug_____="
    ...
    const-string/jumbo v2, "window._____platform_____=1;"
    ...
    const-string/jumbo v4, "window._____platform_os_version_____="
    ...
    const-string/jumbo v4, "window.__NWin_Enable__="
    ...
    const-string/jumbo p2, "}catch(e){console.log(\'__load__plus__ function error=\' + e);}}"

    .line 97
    invoke-virtual {v0, p2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string/jumbo p2, "window.__load__plus__&&window.__load__plus__();"
...
.method private b(Lio/dcloud/common/DHInterface/IApp;)Ljava/lang/String;
    ...
    const-string/jumbo p1, "window.__isUniPush__ = true;"
...
.method public a(Lio/dcloud/common/DHInterface/IWebview;)Ljava/lang/String;
    ...
    const-string/jumbo p1, "window.__WebVieW_Id__= undefined;"
